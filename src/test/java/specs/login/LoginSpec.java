...
public class LoginSpec {
    ...
    public static ResponseSpecification invalidCredentialLoginResponseSpec = new ResponseSpecBuilder()
            .log(ALL)
            .expectStatusCode(401)
            .expectBody(matchesJsonSchemaInClasspath("schemas/login/invalid_credentials_login_response_schema.json"))
